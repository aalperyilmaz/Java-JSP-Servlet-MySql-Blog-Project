    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <form action="contact-edit" method="post" >
                ...
                <div class="mb-3">
                    <input value="" type="text" name="email" placeholder="Email" class="form-control" required />
                </div>

                <div class="mb-3">
                    <input value="" type="text" name="name" placeholder="name" class="form-control" required />
                </div>
